...
AWS_REGION=${DEFAULT_AWS_REGION:-eu-west-3}
...
FRONTEND_BUCKET="${PROJECT_NAME}-${ENVIRONMENT}-frontend-tf-${AWS_ACCOUNT_ID}"
MEMORY_BUCKET="${PROJECT_NAME}-${ENVIRONMENT}-memory-tf-${AWS_ACCOUNT_ID}"
